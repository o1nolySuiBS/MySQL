...
group by DepartmentCity
limit 1;
# 17. Усім клієнтам, які мають вищу ос  віту, встановити усі їхні кредити у розмірі 6000 грн.
...
# delete
# from application
# where Client_idClient in (select idClient from client where substring(LastName, 2, 1) in ('i', 'o', 'u' 'a', 'e'));
